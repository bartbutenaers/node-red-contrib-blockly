...
Blockly.Blocks['object_get'] = {
    init: function () {
        this.jsonInit({
            "type": "object_get",
            "message0": Blockly.Msg.OBJECT_GET_JSON,
            "args0": [
                {
                    "type": "input_value",
                    "name": "object",
            ...
            "output": null,
            "colour": '#F99EA3',
            "tooltip": Blockly.Msg.OBJECT_GET_JSON_TOOLTIP,
            "helpUrl": ""
        });
    }
};
...
Blockly.Blocks['object_set'] = {
    init: function () {
        this.jsonInit({
            "type": "object_set",
            "message0": Blockly.Msg.OBJECT_SET_JSON,
            "args0": [
                {
                    "type": "input_value",
                    "name": "object_field",
            ...
            "nextStatement": null,
            "colour": '#F99EA3',
            "tooltip": Blockly.Msg.OBJECT_SET_JSON_TOOLTIP,
            "helpUrl": ""
        });
    }
};  
