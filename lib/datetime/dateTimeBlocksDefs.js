...
/*
// Conversion to a date object is 'probably' not needed ...
Blockly.Blocks['datetime_convert_to_date'] = {
    init: function () {
        this.jsonInit({
            "type": "datetime_convert_to_date",
            "message0": Blockly.Msg.DATETIME_CONVERT_TO_DATE,
            "args0": [
                {
                    "type": "input_value",
                    "name": "INPUT"
            ...
            "output": 'Date',
            "colour": '#D6316B',
            "tooltip": Blockly.Msg.DATETIME_CONVERT_TO_DATE_TOOLTIP,
            "helpUrl": ""
        });
    }
};
