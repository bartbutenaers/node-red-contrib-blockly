...
Blockly.Blocks['buffer_byte'] = {
    init: function() {
        this.appendDummyInput()
            .appendField("byte")
            .appendField(new Blockly.FieldNumber(0, 0, 255, 1), 'BYTE_VALUE');
        this.setInputsInline(true);
        this.setOutput(true, 'Number');
        this.setNextStatement(false);
        this.setPreviousStatement(false);
        this.setColour("#DF6C06");
        this.setTooltip('Byte value');
    }
};
...
Blockly.Blocks['buffer_empty'] = {
    init: function() {
        this.appendDummyInput()
            .appendField("empty buffer");
        this.setInputsInline(true);
        this.setOutput(true, 'Buffer');
        this.setNextStatement(false);
        this.setPreviousStatement(false);
        this.setColour("#DF6C06");
        this.setTooltip('Create an empty buffer, i.e. buffer with size 0.');
    }
};
