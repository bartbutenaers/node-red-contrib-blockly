Blockly.JavaScript['node_object_get'] = function(block) {
    ...
    if(block.getFieldValue('action') === "REMOVE") {
        switch(value_object) {
            case 'context':
                code = 'context.set(' + value_field_name + ');\n';
                break;
            case 'flow':
                code = 'flow.set(' + value_field_name + ');\n';
                break;
            case 'global':
                code = 'global.set(' + value_field_name + ');\n';
                break;
            default:
                code = 'delete ' + value_object + '[' + value_field_name + '];\n';
        }
