Blockly.Blocks['node_object_get'] = {
    init: function () {
        ...
        this.getField('action').setValidator(function(action) {
            const isStatement = (action === 'REMOVE');
            
            // Check whether this block is currently a statement block, i.e. no value block
            const wasStatement = !thisBlock.outputConnection;
    ...
    domToMutation: function(xmlElement) {
        // When the XML is created, we don't need to do anything special.
        // But you need to have a domToMutation, otherwise the mutationToDom will never be called...
    }
};
